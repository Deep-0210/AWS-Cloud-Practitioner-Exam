...
## 5. EC2 - Elastic Compute Cloud - Infrastructure as a Service
...
* Elastic Block Store (EBS) volume
	...
	- Default another EBS volume is not deleted	
...
* EC2 Image builder:
	- Automate creation of virtual machine or container Image
...
- Store data in disk - EFS, EBS, EC2 instance store, S3
	...
	* Amazon EMR (Hadoop Cluster):
		...
		- Takes care of all the provisioning and configuration od EC2
	...
	* Amazon Athena: Analyze data in S3 using serverless SQL
		...
		- Price are 5$ per TB data scan - Use compressed ot columnar data for cost saving
	...
	* Amazon Blockchain: (exam - Hyper ledger fabric | ethereum | blockchain )
...
* ECS: 
	...
	* Amazon Lightsail:
		...
		- Simple alternative of using EC2, RDS, ELB, ELS
...
* DDOS protection on AWS:
	...
	- AWS WAF (Aeb Application Firewall) - Filter specific request based on rules - Layer 7 is HTTP and Layer 4 TCP - SQL Injection - XSS (Cross Site Scripting)
...
* Data at rest VS Data in transit
	...
	- `KMS - AWS manages the software for encryption - Key also managed ny AWS`
	...
	* Type of KMS keys:
		...
		- AWS Own Keys:
			- Collection os CMK that an AWS service own and managed in multiple account
...
* AWS Abuse:
	- Report suspected AWS resource used for abusive ot illegal purpose
...
* Amazon Lex & Connect:
	- Amazon Lex - (ASR) - Automatic speech recognize
		...
		- help to build chatbots and call center bots
...
- Pay less as AWS grow
	...
	## Saving plan
	- commit certain $ amount per hour foe 1 or 3 year
	- EC2 saving plan
		- 72% discount
